...
namespace Lab5.Persistence.Repository
{
    ...
    public class FakeSushiRepository : IRepository<Sushi>
    {
        ...
        public FakeSushiRepository(DbContext dbContext)
        {
            ...
            _list.Add(new Sushi("Ролл с лососем", 8, 1, 1));
            _list.Add(new Sushi("Ролл с лососем и сливочным сыром", 8, 2, 1));

            _list.Add(new Sushi("Ролл морских водорослях со сливочным сыром, краб миксом, такуаном, соусом Ореховым и кунжутом", 8, 1, 2));
            _list.Add(new Sushi("Ролл в миксе копченого лосося и морского окуня со сливочным сыром и тобико с сливочным сыром, салатом айсберг, картофелем пай", 8, 2, 2));
        }
